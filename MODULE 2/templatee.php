...
if (empty ($error)) {
    ...
    $BodMassIndex = $berat_badan / ($tinggi_meter * $tinggi_meter);
    if ($BodMassIndex <= 18.4) {
        $BodMassIndex_status = "Underweight";
    }   elseif ($BodMassIndex >= 18.5 && $BodMassIndex <= 24.9) {
        $BodMassIndex_status = "Normal";
    }   elseif ($BodMassIndex >= 25.0 && $BodMassIndex <= 39.9) {
        $BodMassIndex_status = "Overweight";
    }   elseif ($BodMassIndex >= 40) {
        $BodMassIndex_status = "Obese";
    }
} 
        ...
        <div class="col-md-4 p-3">
            <div class="card">
                <div class="card-body">
                    ...
                    if (isset ($BodMassIndex)) {
                        echo " Your BMI$BodMassIndex " .$BodMassIndex;
                        echo $BodMassIndex_status;
                    }
